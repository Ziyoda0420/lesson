...
import Star from'../components/Illustration.svg'
import Header from './Header'
const Main = () => {
  return (
     <div className='  gap-40 justify-center mt-10  flex bg-Neutral/Silver'>
       <div className='auto mt-20'>
        <p className='text-[51px] weight-[700]'>Lessons and insights<br/> <span className='text-green-600'>from 8 years</span></p>
